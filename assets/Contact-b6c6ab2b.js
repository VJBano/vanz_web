import{j as e,s as i}from"./index-a82fa87f.js";import{a as n}from"./vendor-7dae7438.js";import{e as y}from"./utils-34eb3db1.js";import{S as j,a as N}from"./SectionWrapper-97538246.js";import{b as w}from"./components-c2c60774.js";import{m as S}from"./animations-e9baa797.js";const _=()=>{const c="service_0qarrc2",d="template_nmfud0v",p="V15d_l2X-KzMzFQUp",x=n.useRef(null),[a,m]=n.useState({name:"",email:"",message:""}),[u,t]=n.useState(!1),[f,r]=n.useState(!1),g=()=>{r(!0)},h=()=>{r(!1)},s=o=>{const{name:l,value:v}=o.target;m({...a,[l]:v})},b=o=>{if(o.preventDefault(),t(!0),a.email==""||a.message==""||a.name==""){alert("Provide All Information"),t(!1);return}y.send(c,d,{from_name:a.name,to_name:"Vincent Jay Bano",from_email:a.email,to_email:"vincentjaybano45@gmail.com",message:a.message},p).then(()=>{t(!1),alert("Thank you. I will get back to you as soon as possible."),m({name:"",email:"",message:""})},l=>{t(!1),console.log(l),alert("Something went wrong. Please try again.")})};return e.jsx("div",{className:`-mt-[8rem] xl:flex-row flex-col-reverse 
      flex gap-5 overflow-hidden`,children:e.jsxs(S.div,{variants:N("left","tween",.2,1),className:"flex-[100] bg-jet p-8 rounded-2xl",children:[e.jsx("p",{className:i.sectionSubText,children:"Get in touch"}),e.jsx("h3",{className:i.sectionHeadTextLight,children:"Contact."}),e.jsxs("form",{ref:x,onSubmit:b,className:"mt-10 flex flex-col gap-6 font-poppins",children:[e.jsxs("label",{className:"flex flex-col",children:[e.jsx("span",{className:"text-timberWolf font-medium mb-4",children:"Your Name"}),e.jsx("input",{type:"text",name:"name",value:a.name,onChange:s,placeholder:"What's your name?",className:`bg-eerieBlack py-4 px-6
